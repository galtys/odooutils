...
let
  ...
  pj_bridgman_addons=inputs.pj_bridgman.packages.x86_64-linux.pj_bridgman_addons;
    ...
    systemd.services.migrated_pjb70  = {
      ...
      serviceConfig = {
        User = mainCFG.user;
          ...
          ExecStart = "${migrated_pjb70}/bin/openerp-server --addons-path=${migrated_pjb70}/bin/addons,${pj_bridgman_addons}/lib/python2.7/site-packages -c ${mainCFG.config_file}  --pidfile=${mainCFG.stateDir}/pjbrefct.pid";};
    };
