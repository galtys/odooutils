    ...
    systemd.services.migrated_pjb70  = {
      ...
      serviceConfig = {
        User = mainCFG.user;
          ...
          ExecStart = "${migrated_pjb70}/bin/openerp-server --addons-path=${migrated_pjb70}/bin/addons,${pj_bridgman_addons}/bin"; -c ${mainCFG.config_file}  --pidfile=${mainCFG.stateDir}/pjbrefct.pid};
    };
